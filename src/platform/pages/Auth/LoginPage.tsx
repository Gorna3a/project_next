    ...
    <div className="space-y-8">
      ...
      {error && (
        <motion.div
          ...
          className="p-4 rounded-2xl bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 text-red-700 dark:text-red-400 text-sm font-bold flex items-center gap-3"
        >
